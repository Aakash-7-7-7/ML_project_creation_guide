...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        '''
        This will do Data transformation 
        '''
        try:
            ...
            logging.info(f"Categgorical columns: {categorical_columns}")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            target_column_name="math_score" #### this is where we define the target we want to study
            numerical_columns=["writing_score","reading_score"]
            ...
            logging.info(
                f"Appliying preprocessing on training and testing dataframe"
